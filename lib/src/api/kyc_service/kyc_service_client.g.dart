...
class _KycServiceClient implements KycServiceClient {
  ...
  Future<V1GetDataResponse> kycServiceGetData(
    ...
    final _value = V1GetDataResponse.fromJson(_result.data!);
    return _value;
  }
  ...
  Future<V1GetPartnerInfoResponse> kycServiceGetPartnerInfo(
    ...
    final _value = V1GetPartnerInfoResponse.fromJson(_result.data!);
    return _value;
  }
  ...
  Future<V1GetValidationResultResponse> kycServiceGetValidationResult(
    ...
    _data.addAll(body.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<V1GetValidationResultResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
